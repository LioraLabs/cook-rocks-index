...
description = {
   ...
   detailed = [[
cook_ai 0.1.0-2 — bin/cook_ai_call now reads ANTHROPIC_BASE_URL from env to
route through a proxy/gateway. Defaults to https://api.anthropic.com when
unset (no-op for direct-API users). No surface change in init.lua /
provider.lua / prompt.lua.
